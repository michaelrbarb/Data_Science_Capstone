                  ...
                  tabPanel("Word Prediction App",
                   ...
                   tabPanel("About",
                            ...
                            p("This application was created for the Coursera Johns Hopkins Data 
                              ...
                              so as to mainly get texts consisting of the desired language (in this
                              case Enlish). The application uses 2-gram relationships derived from
                              a sample of the forementioned texts to predict the next word. I     
                              enjoyed all the JHU Data Science classes and would recommend them to
                              anyone interested in the subject. I hope you like the app!")))))
